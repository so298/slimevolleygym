"""
This file is originally from OpenAI's gym library at version 0.21.0.
source: https://github.com/openai/gym/blob/v0.21.0/gym/envs/classic_control/rendering.py
